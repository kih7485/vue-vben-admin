...
const options: VxeGridProps<RowType> = {
  // Enable Cell Area features (Excel-like selection, copy/paste)
  cellArea: {
...
const [Grid, gridApi] = useVbenVxeGrid<RowType>(options);

// Cell Area is now automatically enabled via gridOptions.cellArea
// No manual enableCellArea() call needed!
  ...
  >
    ...
    <div class="mb-4 rounded bg-blue-50 p-4">
      ...
      <ul class="ml-4 list-disc space-y-1 text-sm">
        <li>
          <strong>Cell Selection:</strong> Click and drag to select cells, or
          Shift+Click to extend selection
        </li>
        <li>
          <strong>Keyboard Navigation:</strong> Use arrow keys to move
          selection, Shift+Arrow to extend
        </li>
        <li>
          <strong>Copy/Paste:</strong> Press Ctrl+C to copy, Ctrl+V to paste
          (works with Excel!)
        </li>
        <li>
          <strong>Drag Fill:</strong> Drag the blue square at bottom-right
          corner to fill cells
        </li>
        <li>
          <strong>Tab Navigation:</strong> Press Tab to move right, Shift+Tab to
          move left
        </li>
        <li>
          <strong>Enter Navigation:</strong> Press Enter to move down,
